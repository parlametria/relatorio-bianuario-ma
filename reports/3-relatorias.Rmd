...
```{r}
relatorias %>% 
  filter(!is.na(governismo), !is.na(classificacao_ambientalismo), classificacao_ambientalismo != "Neutro") %>%
  ggplot(aes(x = governismo, fill = classificacao_ambientalismo)) + 
